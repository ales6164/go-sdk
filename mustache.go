...
func (tmpl *Template) Render(context ...interface{}) *bytes.Buffer {
...
func (tmpl *Template) RenderInLayout(layout *Template, context ...interface{}) *bytes.Buffer {
	content := tmpl.Render(context...)
	allContext := make([]interface{}, len(context)+1)
	copy(allContext[1:], context)
	allContext[0] = map[string]string{"content": content.String()}
